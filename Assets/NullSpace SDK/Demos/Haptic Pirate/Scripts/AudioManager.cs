...
public class AudioManager : Singleton<AudioManager>
{
	...
	public override void Awake()
	{
		...
		{
			audioSourcePrefab = Resources.Load<GameObject>("Prefabs/Audio Source Prefab");
		}
		//if (liveSources == null)
		//{
	...
	/// </summary>
	/// <param name="clip">If you already have a reference to the audio clip</param>
	...
	/// <returns></returns>
	public AudioSource MakeSource(AudioClip clip, Vector3 sourcePosition = default(Vector3), Transform parent = null)
	{
		AudioSource newAudSource = MakeSource(sourcePosition, parent);
		...
		if (newAudSource != null && clip != null)
		{
			newAudSource.name = "Audio Source (" + clip.name + ")";
			newAudSource.clip = clip;
		}
		return newAudSource;
	}
	...
	/// <param name="parent">Defaults to following the player around. If you want a nonmoving audio, use MakeSourceAtPos</param>
	/// <returns></returns>
	public AudioSource MakeSource(string clipName, Vector3 sourcePosition = default(Vector3), Transform parent = null)
	{
		AudioSource newAudSource = MakeSource(sourcePosition, parent);
		//newAudSource.loop = true;
		...
		if (newAudSource != null)
		{
			newAudSource.name = "Audio Source (" + clipName + ")";
			newAudSource.clip = FindOrLoadAudioClip(clipName);
		}
		return newAudSource;
	}

	private AudioSource MakeSource(Vector3 sourcePosition = default(Vector3), Transform parent = null)
	{
		GameObject newAudSourceGO = (GameObject)Instantiate(audioSourcePrefab, Vector3.zero, Quaternion.identity);
		AudioSource newAudSource = null;

		newAudSourceGO.name = "Audio Source (" + "unnamed" + ")";
	...
	/// <summary>
	/// Finds a clip in Resources/Audio
	/// </summary>
	/// <param name="clipName">"Do not include "Audio/" in the name</param>
	/// <returns></returns>
