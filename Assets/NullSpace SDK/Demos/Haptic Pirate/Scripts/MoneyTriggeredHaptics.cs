...
namespace NullSpace.SDK.Demos
{
	...
	public class MoneyTriggeredHaptics : MonoBehaviour
	{
		/// <summary>
		...
		public enum CollisionType { MinorCoinHit, SharpImpact, ThudImpact, MediumCashPackHit, SackOfGoldhit, MudBlob}
		/// <summary>
		...
		/// </summary>
		public CollisionType typeOfCollision = CollisionType.MinorCoinHit;
		...
		/// </summary>
		private bool CheckIfTrigger = false;
		...
		public void Collide(Collider col, Vector3 where)
		{
			...
			if (col.gameObject.layer == NSManager.HAPTIC_LAYER && MyRB != null && MyRB.velocity.sqrMagnitude > 3)
			{
