...
namespace NullSpace.SDK.Demos
{
	abstract public class SuitDemo : MonoBehaviour
	{
		...
		public virtual void SetupButtons()
		{
			...
			{
				MyEnableButton.transform.Find("Icon").GetComponent<Image>().sprite = EnabledSprite;
			}
			if (MyDisableButton != null)
			{
				MyDisableButton.transform.Find("Icon").GetComponent<Image>().sprite = DisabledSprite;
			}
		}
